...
const DEFAULT_DATA_READING_PERIOD = 300;

// Data sending period, in seconds
const DEFAULT_DATA_SENDING_PERIOD = 300;

// Alert settings:

// Temperature high alert threshold, in Celsius
const DEFAULT_TEMPERATURE_HIGH =  50;
// Temperature low alert threshold, in Celsius
const DEFAULT_TEMPERATURE_LOW = 0;
// Battery low alert threshold, in %
const DEFAULT_BATTERY_LOW = 7;
...
const DEFAULT_MOTION_DISTANCE = 0.0;
